...
DESCRIPTION_DIR = PACKAGE_DIR / "assets/descriptions"
# Non-package data
ASSET_DIR = Path(ROOT_DIR, "data")
LOCALGRASP_DIR = PACKAGE_DIR / "localgrasp"
ALGORITHM_DIR = PACKAGE_DIR / "algorithms"
RLMODEL_DIR = PACKAGE_DIR / "algorithms/logs"
...
def get_commit_info(show_modified_files=False, show_untracked_files=False):
    ...
    try:
        ...
        logger.warning("gap_rl is not installed with git.")
        return None
    else:
        commit_info = {
